...
pub use frame_ops::{
    add_frame, duplicate_frame, remove_frame, reorder_frame, set_frame_duration, FrameOpError,
};
pub use io::export_png::{
    validate_gif_dimensions, validate_png_dimensions, validate_spritesheet_dimensions,
    PngExportError, MAX_PNG_PIXELS,
};
pub use io::export_text::{
    export_frame_text, export_text, export_text_frames, export_text_frames_with_trim,
};
...
pub use layer_ops::{
    add_layer, duplicate_layer, remove_layer, reorder_layer, set_layer_name, set_layer_visibility,
    LayerOpError,
};
